namespace CommonTools.Authentication
{
    ...
    public class AuthenticationProvider : ObjectRoot, IRequestAuthenticationProvider
    {
        ...
        {
            this.GraphLogger.Debug("ValidateInboundRequestAsync start");
            ...
            // Aet the Issuer(s) and Audience(s) to validate and assign the SigningKeys which were downloaded from AuthDomain.
            ...
            {
                this.GraphLogger.Debug($"ValidateToken error: {ex.Message}");
                if (ex.InnerException != null)
                {
                    this.GraphLogger.Debug($"InnerException: {ex.InnerException.Message}");
                }
                // Some other error
