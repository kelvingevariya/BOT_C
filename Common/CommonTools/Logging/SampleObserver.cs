namespace CommonTools.Logging
{
    ...
    /// </summary>
    public class CommonObserver : IObserver<LogEvent>, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonObserver" /> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        public CommonObserver(IGraphLogger logger)
        {
