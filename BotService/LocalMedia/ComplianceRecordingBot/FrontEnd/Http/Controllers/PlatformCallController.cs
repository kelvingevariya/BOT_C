...
namespace ComplianceRecordingBot.FrontEnd.Http
{
    ...
    public class PlatformCallController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> OnIncomingRequestAsync()
        {
            ...
            NLogHelper.Instance.Debug($"[PlatformCallController] OnIncomingRequestAsync Received HTTP {this.Request.Method}, {this.Request.RequestUri}");
        ...
        {
            NLogHelper.Instance.Debug($"[PlatformCallController] ProcessNotificationAsync start");
            ...
            NLogHelper.Instance.Debug($"[PlatformCallController] scenarioId: {scenarioId} requestId: {requestId}");
            ...
            {
                NLogHelper.Instance.Debug($"[PlatformCallController Error] ProcessNotifications Msg: {ex.Message}");
                if (ex.InnerException != null)
                {
                    NLogHelper.Instance.Debug($"[PlatformCallController Error] InnerException: {ex.InnerException.Message}");
                }
